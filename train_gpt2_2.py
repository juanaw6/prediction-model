...
config = GPT2Config(
    ...
    n_positions=512,  # Keep small since dataset is small
    n_ctx=512,
    n_embd=768,  # Keep smaller to reduce overfitting
    n_layer=6,   # Reduce depth to avoid overfitting
    n_head=8,    # Fewer heads = better efficiency
    resid_pdrop=0.2,  # More dropout to prevent overfitting
    attn_pdrop=0.2,  
    embd_pdrop=0.2,  
